...
{
    /// <summary>
    ///     Helper to make a PasswordBoxes value bind-able. Just set Attach=True and use the Password property to bind the value
    ///     Source: https://www.wpftutorial.net/PasswordBox.html
    /// </summary>
